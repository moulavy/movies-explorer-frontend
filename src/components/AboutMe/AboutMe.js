            ...
            <div className="about-me__content">
               <div className="about-me__info">
                  ...
                  <p className="about-me__description">Я родилась в Астрахани, но недавно переехала в Санкт-Петербург. Закончила Астраханский Государственный Университет
                     по направлению "Прикладная математика и информатика". Я люблю играть в настольные игры, видеоигры, смотреть фильмы, сериалы и аниме, а также много гулять.
                  ...
                  <a className="about-me__github" target="_blank" href='https://github.com/moulavy'>Github</a>
               </div>
